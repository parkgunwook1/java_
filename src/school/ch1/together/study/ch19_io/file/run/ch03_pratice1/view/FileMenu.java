package school.ch1.together.study.ch19_io.file.run.ch03_pratice1.view;

import school.ch1.together.study.ch19_io.file.run.ch03_pratice1.controller.FileController;
...
//            }
    ...
    public void fileEdit() {
        ...
        while (true) {
            ...
            else if(fc.checkName(file)) {
                if (inputLine.equals("ex끝it")) {
                    break;
                }// ex끝it 외 다른 것을 적을시 StringBuilder(content) 에 inputLine 을 추가한다.
                fc.fileEdit(inputLine,sb);
            }
        }
    }
}
